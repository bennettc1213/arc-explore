...
- The extension bridge's origin check (sender is window.parent, that parent is window.top, origin matches a configured Arc origin) is a hard invariant — never relax it, never reply to a "*" target, keep exactly one fill routine.
